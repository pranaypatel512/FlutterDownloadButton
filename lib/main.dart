...
class ButtonShapeWidget extends StatelessWidget{
  ...
  @override
  Widget build(BuildContext context) {
    var shape = const ShapeDecoration(shape: StadiumBorder(),color: CupertinoColors.lightBackgroundGray);
    if(isDownloading || isFetching){
      shape = ShapeDecoration(shape: const CircleBorder(),color: Colors.white.withOpacity(0.0));
    }
...
class SimulatedDownloadController extends DownloadController with ChangeNotifier{
  ...
  Future<void> _doSimulatedDownload() async {
    ...
    const downloadProgressStops = [0.0, 0.25, 0.45, 0.8, 1.0];
